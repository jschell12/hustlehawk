...
exports.search = function(keywords, location, cb){        
    ...
    keywords = keywords || "";
    var options = {
        host: 'http://api.simplyhired.com/a/jobs-api/xml-v2/ws-25/mi-25/l-' + location + '/q-' + keywords + '/?pshid=40556&ssty=2&cflg=r&jbd=jobberjab.jobamatic.com&clip=24.188.247.43'
    };
